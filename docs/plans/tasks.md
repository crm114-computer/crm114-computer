...
- [x] gum-progress-phases — Apply Gum spinners/logs to additional installer stages (plan: gum-powered-installer)
- [x] gum-helper-toolkit — Build Gum helper functions and fallbacks for installer (plan: gum-powered-installer)
- [x] gum-storytelling-guidelines — Document friendly language patterns for installer output (plan: gum-powered-installer)
