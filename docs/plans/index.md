...
- [ ] installer-debug-flag — Provide a --debug flag and verbose tracing so humans can share actionable installer diagnostics (`docs/plans/installer-debug-flag.md`)
- [ ] hidden-user-account-spec — Define UID/GID, attributes, filesystem state, and messaging for the hidden `crm114` account (`docs/plans/hidden-user-account-spec.md`)
